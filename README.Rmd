...
{
  model <- conquer2adaptive::conquer.reg(X, y, penalty = 'lasso', lambda = lambda_values[i], tau = 0.5)
...
```{r}
model <- conquer2adaptive::conquer.reg(X, y, penalty = 'group', group=1:10, lambda = 0.01, tau = 0.5)
model$coeff
```
